...
class SemanticAnalyzerTest {
    ...
    void acceptsValidNumberDeclaration() {
        // let x: number = 5;
        VarDeclarationStatement stmt = new VarDeclarationStatement(
                new Identifier("x", dummyPos),
                "number",
                new NumberLiteral(5.0, dummyPos),
                dummyPos
        );
    ...
    void throwsOnUndeclaredVariableUsage() {
        ...
        AssignmentStatement stmt = new AssignmentStatement(
                new Identifier("x", dummyPos),
                new NumberLiteral(10.0, dummyPos),
                dummyPos
        );
    ...
    void throwsOnInvalidMathOperation() {
        ...
        BinaryExpression expr = new BinaryExpression(
                new StringLiteral("hola", dummyPos),
                "-",
                new NumberLiteral(5.0, dummyPos),
                dummyPos
        );
