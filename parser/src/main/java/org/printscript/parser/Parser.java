 ...
 *
 * <p>Extiende {@link Iterator}{@code <Statement>}: produce una sentencia
 * por llamada a {@link #next()}, sin materializar el árbol completo.
 *
 * <p>El parser no conoce al lexer. Solo consume tokens de un {@code Iterator<Token>}
 * que recibe en su constructor. Es responsabilidad del orquestador (CLI)
 * crear el lexer y pasarle el iterador de tokens al parser.
 *
