...
class AnalyzerVisitorTest {
    ...
    void testCamelCaseViolation() {
        ...
        VarDeclarationStatement stmt = new VarDeclarationStatement(id, "number", initializer, defaultPos);
    ...
    void testUnusedVariableWarning() {
        ...
        VarDeclarationStatement stmt = new VarDeclarationStatement(id, "number", new NumberLiteral(5, defaultPos), defaultPos);
    ...
    void testUsedVariableNoWarning() {
        ...
        AssignmentStatement assignStmt = new AssignmentStatement(id, new NumberLiteral(2, defaultPos), defaultPos);
    ...
    void testComplexPrintlnViolation() {
        ...
        BinaryExpression complexExpr = new BinaryExpression(
                new NumberLiteral(2, defaultPos),
                "+",
                new NumberLiteral(2, defaultPos),
                defaultPos
        );
