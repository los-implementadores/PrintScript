...
/**
 * Implementación de {@link Program} que materializa todas las sentencias
 * en una lista inmutable en el momento de construcción.
 *
 * <p>Usar cuando se necesita el árbol completo disponible de inmediato,
 * por ejemplo en el analyzer (que puede hacer múltiples pasadas) o en tests.
 *
 * <pre>
...
public final class EagerProgram implements Program {
    ...
    /**
     * Devuelve la lista inmutable de sentencias cargada en construcción.
     * O(1), sin trabajo adicional.
     */
    @Override
    ...
    /**
     * Devuelve un iterator sobre la lista inmutable.
