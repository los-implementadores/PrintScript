 ...
 *
 * <p>Cada implementación es responsable de un tipo de token (identificadores,
 * números, strings, símbolos, etc.). El lexer itera la lista de matchers hasta
 * que uno puede manejar el caracter actual.
 *
 * <p>Para agregar un nuevo tipo de token al lenguaje, basta con crear una nueva
 * implementación de esta interfaz y agregarla a la lista — sin modificar el lexer
...
public interface TokenMatcher {
     ...
     *
     * <p>Solo se invoca si {@link #matches(char)} devolvió {@code true}.
     * La implementación debe consumir todos los caracteres que forman el token
     * usando los métodos de {@link LexerContext}.
     *
