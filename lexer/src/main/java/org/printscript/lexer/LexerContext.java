...
/**
 * Contexto que el lexer expone a cada {@link TokenMatcher} para que pueda
 * leer caracteres, avanzar en el flujo y construir tokens.
 *
 * <p>Encapsula el estado interno del lexer (posición, caracter actual) y evita
 * que los matchers conozcan la implementación completa.
 */
public interface LexerContext {
     ...
     */
    Token createToken(TokenType type, String lexeme,
