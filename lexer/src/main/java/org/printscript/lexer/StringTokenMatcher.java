 ...
 *
 * <p>Lanza {@link LexerException} si el string no se cierra antes de llegar al
 * final del archivo.
 */
public class StringTokenMatcher implements TokenMatcher {
    ...
    public Token extract(LexerContext context) {
        ...
        if (context.getCurrentChar() == -1) {
            Position position = new Position(startLine, startColumn,
        ...
        return context.createToken(TokenType.STRING_LITERAL, sb.toString(),
