 ...
 *
 * <p>Reconoce secuencias que empiezan con letra o {@code _} y continúan con letras, dígitos o
 * {@code _}. Luego busca el lexema en el mapa de keywords: si está, devuelve el tipo
 * correspondiente; si no, devuelve {@code IDENTIFIER}.
 */
