 ...
 *
 * <p>Reconoce cualquier caracter que esté registrado en el mapa de símbolos.
 * Para agregar un nuevo operador, basta con agregarlo al mapa — sin crear
 * una clase nueva ni modificar esta.
 */
public class SymbolTokenMatcher implements TokenMatcher {
    ...
    public Token extract(LexerContext context) {
        ...
        return context.createToken(type, String.valueOf(c),
