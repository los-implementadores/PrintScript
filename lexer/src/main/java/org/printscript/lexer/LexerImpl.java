 ...
 *
 * <p>Recibe una lista de {@link TokenMatcher} por constructor. Para producir un
 * token, itera los matchers hasta que uno reconoce el caracter actual y lo extrae.
 * Esto cumple el Open/Closed Principle: para soportar nuevos tipos de tokens,
 * se agrega un matcher nuevo sin modificar esta clase.
 *
 * <p>Implementa también {@link LexerContext} para exponer su estado interno a los
 * matchers de forma controlada.
 */
public class LexerImpl implements Lexer, LexerContext {
    ...
    @Override
    public Token createToken(TokenType type, String lexeme,
